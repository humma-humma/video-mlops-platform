...
#SBATCH -o slurm_outputs/baseline_pipeline_compile-%A_%a.out
#SBATCH -e slurm_outputs/baseline_pipeline_compile-%A_%a.err
#
...
uv run main.py \
    ...
    --file-name smol_vlm_2.2b_pipeline_compile
