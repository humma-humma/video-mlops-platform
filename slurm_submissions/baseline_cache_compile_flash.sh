...
#SBATCH -o slurm_outputs/baseline_pipeline_cache_compile_flash-%A_%a.out
#SBATCH -e slurm_outputs/baseline_pipeline_cache_compile_flash-%A_%a.err
#
...
uv run main.py \
    ...
    --file-name smol_vlm_2.2b_pipeline_cache_compile_flash
